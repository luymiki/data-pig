...
public class PageUtils {
    ...
    public static int computePageNumber(int pageNumber, int pageSize, int totalElements) {
        return pageNumber <= 1 ? 1 : (Integer.MAX_VALUE != pageNumber && pageNumber <= computeLastPageNumber(totalElements, pageSize) ? pageNumber : computeLastPageNumber(totalElements, pageSize));
    }
}
