...
public class DateColumn extends Column {
    ...
    @Override
    public byte[] asBytes() {
        throw new DataPigException("Date类型不能转为Bytes .");
    }

    @Override
    public Boolean asBoolean() {
        throw new DataPigException("Date类型不能转为Boolean .");
    }

    @Override
    public Double asDouble() {
        throw new DataPigException("Date类型不能转为Double .");
    }

    @Override
    public BigInteger asBigInteger() {
        throw new DataPigException("Date类型不能转为BigInteger .");
    }

    @Override
    public Object asObject() {
        return asDate() != null ? new Timestamp(asDate().getTime()) : null;
    }

    @Override
    public BigDecimal asBigDecimal() {
        throw new DataPigException("Date类型不能转为BigDecimal .");
    }
