...
//    }
    ...
    public static Connection getConnection(final DataBaseType dataBaseType,
        ...
        return getConnection(dataBaseType, jdbcUrl, username, password, String.valueOf(600 * 1000));
    }
    ...
    public static Connection getConnectionWithoutRetry(final DataBaseType dataBaseType,
        ...
        return getConnectionWithoutRetry(dataBaseType, jdbcUrl, username,
                password, String.valueOf(60 * 1000));
    }
    ...
    private static synchronized Connection connect(DataBaseType dataBaseType,
        ...
        return connect(dataBaseType, url, user, pass, String.valueOf(60 * 1000));
    }
    ...
    private static synchronized Connection connect(DataBaseType dataBaseType,
        ...
        //ob10的处理
        if (url.startsWith(OB10_SPLIT_STRING) && dataBaseType == DataBaseType.MYSQL) {
            String[] ss = url.split(OB10_SPLIT_STRING_PATTERN);
            if (ss.length != 3) {
                throw new DataPigException("JDBC OB10格式错误!");
            }
    ...
    public static ResultSet query(Connection conn, String sql, int fetchSize)
        ...
        return query(conn, sql, fetchSize, 3600);
    }
...
//    }
    ...
    private static void doDealWithSessionConfig(Connection conn,
        ...
        try {
            ...
            throw new DataPigException(String
        ...
        for (String sessionSql : sessions) {
            ...
            try {
                ...
                throw new DataPigException(String.format(
    ...
    public static void sqlValid(String sql, DataBaseType dataBaseType) {
        SQLStatementParser statementParser = SQLParserUtils.createSQLStatementParser(sql, dataBaseType.name());
    ...
    public static boolean asyncResultSetNext(final ResultSet resultSet, int timeout) {
        ...
        try {
            ...
            throw new DataPigException("异步获取ResultSet失败", e);
        }
    }
